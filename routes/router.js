...
const { getMarkets, getProducts, getDeals, getTransactions, postRequest, loadNotifications, loadOrders, loadProducts, fetchPrices } = require("../controllers/buyerController");
